...
public enum Key {
    ...
    GPS_ALTITUDE("EXIF:GPSAltitude", String.class,"海拔"),
    GPS_ALTITUDE_REF("EXIF:GPSAltitudeRef", Integer.class),
    GPS_BEARING("EXIF:GPSDestBearing", Double.class),
    GPS_BEARING_REF("EXIF:GPSDestBearingRef", String.class),
    GPS_LATITUDE("EXIF:GPSLatitude", Double.class,"纬度"),
    GPS_LATITUDE_REF("EXIF:GPSLatitudeRef", String.class),
    GPS_LONGITUDE("EXIF:GPSLongitude", Double.class,"经度"),
    GPS_LONGITUDE_REF("EXIF:GPSLongitudeRef", String.class),
    GPS_PROCESS_METHOD("GPSProcessingMethod", String.class),
    GPS_SPEED("EXIF:GPSSpeed", Double.class),
    GPS_SPEED_REF("EXIF:GPSSpeedRef", String.class),
    GPS_DATETIME("EXIF:GPSDatetime", String.class),
