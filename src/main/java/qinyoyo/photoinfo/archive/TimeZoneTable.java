...
public class TimeZoneTable {
    public static final List<String[]> countryTimeZones = new ArrayList<String[]>() {{
        ...
        add(new String[]{"PS","Palestinian Territory","巴勒斯坦","Asia/Hebron"});
        ...
        add(new String[]{"KP","Democratic People's Republic of Korea","朝鲜","Asia/Pyongyang"});
        add(new String[]{"GQ","Equatorial Guinea","赤道几内亚","Africa/Malabo"});
        add(new String[]{"GB","United Kingdom","大不列颠联合王国","Europe/London"});
        add(new String[]{"DK","Denmark","丹麦","Europe/Copenhagen"});
        add(new String[]{"DE","Germany","德国","Europe/Berlin"});
        add(new String[]{"TL","Timor-Leste","东帝汶","Asia/Dili"});
        ...
        add(new String[]{"RU","Russian Federation","俄罗斯","Europe/Moscow","Asia/Omsk","Asia/Yekaterinburg","Europe/Samara","Europe/Kaliningrad","Asia/Kamchatka","Asia/Sakhalin","Asia/Vladivostok","Asia/Yakutsk","Asia/Irkutsk","Asia/Tomsk"});
        ...
        add(new String[]{"CG","Congo","刚果","Africa/Brazzaville"});
        add(new String[]{"CD","Congo","刚果民主共和国","Africa/Kinshasa","Africa/Lubumbashi"});
        ...
        add(new String[]{"KR","Korea","韩国","Asia/Seoul"});
        ...
        add(new String[]{"LA","Lao People's Democratic Republic","老挝","Asia/Vientiane"});
        ...
        add(new String[]{"RE","Réunion","留尼汪","Indian/Reunion"});
        ...
        add(new String[]{"BL","Saint Barthélemy","圣巴泰勒米","America/St_Barthelemy"});
        ...
        add(new String[]{"SY","Syrian Arab Republic","叙利亚","Asia/Damascus"});
        ...
        add(new String[]{"VG","Virgin Islands, British","英属群岛（英属）群岛","America/Tortola"});
